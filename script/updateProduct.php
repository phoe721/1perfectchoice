			...
			if (!empty($line)) {
				...
				if ($validator->check_sku($sku)) {
					...
					if ($product->check_exist($code, $item_no)) {
						if ($product->update($code, $item_no, $item_type, $title, $description, $feature1, $feature2, $feature3, $feature4, $feature5, $feature6, $feature7, $feature8, $feature9, $feature10, $color, $material)) {
