...
function get_type($str) {
	...
	} else if (preg_match('/\brack\b/', $str)) {
	...
	} else if (preg_match('/\b(dresser|wardrobe)\b/', $str)) {
		$type = "dressers";
