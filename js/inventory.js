$(document).ready(function() {
    ...
    // Upload button toggles output box
    ...
    $('#housekeeping').click(function() {
        if (confirm("Are you sure you want to do housekeeping?") == true) {
            $.post('script/housekeeping.php');
            alert("Housekeeping done!");
        } else {
            alert("Housekeeping not executed!");
        }
    });

    // Validate file when changed
